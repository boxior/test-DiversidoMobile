...
$(function(){
    ...
    function dashHeaderCut(){
        var dashStart = $('.dashboard__header p').text();
        var dashNew;
        ...
        $('.dashboard__header p').text(dashNew);
    }

    //Select Dashboard
    var dashMainLength = $('.dashboard__header p').text().length;
    $('.dashboard__item').on('click' ,function(){
        
        $(this).parent().fadeOut(0);
        $('.dashboard__header p').text($(this).text());
